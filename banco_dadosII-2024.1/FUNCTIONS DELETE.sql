	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR O CLIENTE DE CPF %. CHAVE ESTRANGEIRA VIOLADA.', CPF_C;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR O CARGO %. CHAVE ESTRANGEIRA VIOLADA.', NOME_C;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN 
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR A LOJA DE CNPJ %. CHAVE ESTRANGEIRA VIOLADA.', CNPJ_L;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR O FUNCIONARIO DE CPF %. CHAVE ESTRANGEIRA VIOLADA.', CPF_F;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN 
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR O PAGAMENTO %. CHAVE ESTRANGEIRA VIOLADA.', NOME_PAG;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR A CATEGORIA %. CHAVE ESTRANGEIRA VIOLADA.', NOME_CAT;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN
	...
	ELSE
		...
		EXCEPTION
			WHEN foreign_key_violation THEN
				RAISE EXCEPTION 'NÃO FOI POSSÍVEL EXCLUIR O PRODUTO %. CHAVE ESTRANGEIRA VIOLADA.', NOME_P;
		END;
	END IF;
END;
$$ LANGUAGE PLPGSQL;
