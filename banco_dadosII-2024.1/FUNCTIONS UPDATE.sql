...
$$ LANGUAGE PLPGSQL;
--ex:
SELECT * FROM UPDATE_ESTOQUE('Camiseta Estampada-Loja 2', NULL, NULL,100) 
...
BEGIN 
	...
	END IF;
END;
$$ LANGUAGE PLPGSQL; --erro de incompatibilidade com o tipo dos atributos !!!!!!!!!!!!!

CREATE OR REPLACE FUNCTION ALTERAR(--ESTOQUE DROP FUNCTION ALTERAR(VARCHAR,VARCHAR,INT,VARCHAR,VARCHAR)
	TABELA VARCHAR(50), 
...
SELECT * FROM estoque
SELECT * FROM produto
SELECT * FROM ALTERAR('estoque','Camiseta Estampada-Loja 1',null,'loja 2',null)
