						...
						IF EXISTS(SELECT * FROM PAGAMENTO WHERE COD = COD_PAG) THEN
							...
							IF EXISTS(SELECT * FROM PEDIDO WHERE COD = COD_PDD) THEN
								...
								UPDATE CREDIARIO SET
									VALOR_PARCELA = (P.VALOR_TOTAL / PARCELAS.QTDD_P)
								FROM PEDIDO P, (SELECT COUNT(QUANTIDADE_PARCELA) QTDD_P FROM CREDIARIO) PARCELAS
...
SELECT PAGAR_CREDIARIO('789.123.456-78', '31-07-2024')
