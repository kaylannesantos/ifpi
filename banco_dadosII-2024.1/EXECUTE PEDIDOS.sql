...
RETURNS TABLE ("n°Pedido" VARCHAR, Cliente VARCHAR(100), Produto VARCHAR(100), Valor NUMERIC(8,2), Quantidade INT, Total NUMERIC(8,2), Data VARCHAR(10), Hora VARCHAR(8), Funcionario VARCHAR(100)) AS $$
DECLARE
	COD_C INT;
	COD_PDD INT;
BEGIN
...
SELECT * FROM NOTA_FISCAL('567.890.123-45')
