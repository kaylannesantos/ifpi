...
$$ LANGUAGE PLPGSQL;
--
SELECT ADD_PEDIDO('987.654.321-00', 'Cinto de Couro', 1, 'Dinheiro', '555.666.777-99')
...
SELECT * FROM NOTA_FISCAL('123.456.789-10')
...
BEGIN
	...
	RETURN QUERY 
		SELECT 
			...
			--SUM(P.VALOR_TOTAL)::NUMERIC(8,2) VALOR_TOTAL,
...
END;
$$ LANGUAGE PLPGSQL;
--drop function relatorio_pedido
SELECT * FROM RELATORIO_PEDIDO('2024-01-01', '2024-06-30')
