...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME VARCHAR(100), CNPJ VARCHAR(18), ENDERECO TEXT) --LOJA
RETURNS VOID AS $$
DECLARE
BEGIN 
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME VARCHAR(100))--PAGAMENTO
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
