...
$$ LANGUAGE PLPGSQL;
--ex:
SELECT ADD_CLIENTE('Liz de Sousa Santos', '900.800.700-10', '(86) 988909090', 'lizssantosthe@gmail.com')
...
$$ LANGUAGE PLPGSQL;
--ex:
SELECT ADD_CARGO('Gerente', 1250.00);
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME VARCHAR(100), CPF VARCHAR(15), CONTATO VARCHAR(20), EMAIL VARCHAR(50)) --CLIENTE
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME_CAR VARCHAR(50), NOME_LOJ VARCHAR(10), NOME VARCHAR(100), CPF VARCHAR(15), CONTATO VARCHAR(20), EMAIL VARCHAR(50)) --FUNCIONARIO
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME VARCHAR(100), SALARIO NUMERIC(8,2)) --CARGO
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), NOME VARCHAR(100), DESCRICAO TEXT) --CATEGORIA
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), CATEGORIA VARCHAR(100), PRODUTO VARCHAR(100), VALOR NUMERIC(8,2)) --PRODUTO
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
...
CREATE OR REPLACE FUNCTION CADASTRAR(TABELA VARCHAR(50), PRODUTO VARCHAR(100), LOJA VARCHAR(10), QUANTIDADE INT) --ESTOQUE
RETURNS VOID AS $$
DECLARE
BEGIN 
	IF TABELA ILIKE 'CLIENTE' THEN
