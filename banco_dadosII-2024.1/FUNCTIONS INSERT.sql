...
CREATE OR REPLACE FUNCTION ADD_CARGO(NOME_C VARCHAR(50), SALARIO_C NUMERIC(8,2), COMISSAO_C NUMERIC(4,2), ATIVO_C BOOLEAN DEFAULT TRUE)--DROP FUNCTION ADD_CARGO
RETURNS VOID AS $$ 
BEGIN 
	IF NOT EXISTS(SELECT * FROM CARGO WHERE NOME ILIKE NOME_C) THEN 
		INSERT INTO CARGO (NOME,SALARIO,COMISSAO, ATIVO) VALUES (NOME_C,SALARIO_C,COMISSAO_C, ATIVO_C);
