...
--------------------------------------------EXCEÇÕES---------------------------------------------------------
CREATE OR REPLACE FUNCTION VERIFICAR_ATRIBUTO(ATRIBUTO VARCHAR)
RETURNS VOID AS $$
BEGIN
	IF ATRIBUTO = '' OR TRIM(ATRIBUTO) = '' THEN
...
RETURNS TRIGGER AS $$
BEGIN
    PERFORM VERIFICAR_ATRIBUTO(NEW.NOME);
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
...
SELECT * FROM CLIENTE
INSERT INTO CLIENTE(NOME, CPF, CONTATO, EMAIL) VALUES('Lua de Almeida Castro', '911.654.311-11', '(86) 988459088', 'luacastro@gmail.com')
...
$$ LANGUAGE PLPGSQL;
--ex:
SELECT ADD_CLIENTE('', '123.776.789-00', '(86) 988458900', 'ivanjr@gmail.com')