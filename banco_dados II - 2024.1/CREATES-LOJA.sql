...
ADD_FUNCIONARIO(NOME_CAR VARCHAR(100), NOME_LOJ VARCHAR(50), NOME_F VARCHAR(100), CPF_F VARCHAR(50), CONTATO_F VARCHAR(50), EMAIL_F VARCHAR(50))
ADD_CATEGORIA(NOME_C VARCHAR(50), DESC_C TEXT)
ADD_PRODUTO(NOME_CAT VARCHAR(100), NOME_P VARCHAR(100), VALOR_P NUMERIC(8,2))
ADD_PAGAMENTO(TIPO_P VARCHAR(50))
ADD_ESTOQUE(NOME_PROD VARCHAR(100), NOME_LOJ VARCHAR(50), QUANT_P INT)